...
echo "put -c .s3cfg --acl-public --guess-mime-type ${ARTIFACTS_DIR}/release_info.json ${S3_URL} "

s3cmd put -c .s3cfg --acl-public --guess-mime-type "$ARTIFACTS_DIR/release_info.json" "$S3_URL"
